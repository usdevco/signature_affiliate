...
class Projects extends Admin_controller
{
    ...
    public function project($id = '')
    {
        ...
        if (count($data['last_project_settings'])) {
            ...
            $data['last_project_settings'][$key]['value'] = $data['last_project_settings'][$key]['value'] ? unserialize($data['last_project_settings'][$key]['value']) : NULL;
        }
    ...
    public function view($id)
    {
        if ($this->projects_model->is_member($id) || has_permission('projects', '', 'view')) {
            ...
            $project->settings->available_features =$project->settings->available_features ? unserialize($project->settings->available_features) : $project->settings->available_features;
            $data['statuses']                      = $this->projects_model->get_project_statuses();
