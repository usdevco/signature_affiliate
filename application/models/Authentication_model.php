...
class Authentication_model extends CRM_Model
{
    ...
    public function login($email, $password, $remember, $staff)
    {
        if ((!empty($email)) and (!empty($password))) {
            ...
            // print_r($user);die($table);
            // $2a$08$WZLSwrL2bRxYIxb2xqJ36eouX/u1JvhhZyZr72NmNGMpDmZgY2KY6
            // $2a$08$VA7JXsE9ybaeZ57gihJVFOWAnpEEMIt5LnNAf/2J4CyDSCq4kkMhi

            // $2a$08$xdpWi44aiqkGW8OdX2HKZe/Ts.zp1WMB1ARdL0DOJxaMTKvZm9Tbq
            // $2a$08$nQnv4/fF0C5PBMWV43sy3Ot0xaiLi8CY0rkZLhzHXEbI7Edu41zYa : 123456

            // $2a$08$pLwJwrmiZe09uRgrFr7TcehyIKm1QKQk.MFHeHSnqusQxtCER5/66
