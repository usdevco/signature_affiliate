                   ...
                   <div class="panel-body">
                      ...
                      <div class="col-12 col-md-12 col-lg-12">
                         <div class="card">
                            <div class="card-body">
                               <?php
                               if(empty($custom_custom_task_id)) 
                               { ?>
                               ...
                               <div class="row">
                                  ...
                                  <div class="col-md-10">
                                     <div class="form-group <?php echo form_error('custom_task_id') ? ' has-error' : ''; ?>">
                                        <?php echo  form_label('Task List', 'custom_task_id'); ?> 
                                        <span class="required text-danger">*</span>
                                        
                                           <select name="custom_task_id" class="form-control selectpicker" data-width="100%" data-none-selected-text="Nothing selected" data-live-search="true" tabindex="-98">
                                              
                                              <?php  
                                              $populateData = (!empty($task_hoa_data_array->custom_task_id) && isset($task_hoa_data_array->custom_task_id) ? $task_hoa_data_array->custom_task_id : (!empty($this->input->post('custom_task_id')) ? $this->input->post('custom_task_id') : '' )); 
                                              ?>  
                                        ...
                                        <span class="small form-error"> <?php echo strip_tags(form_error('custom_task_id')); ?> </span>
                                     </div>
                                  </div>
                                  <?php 
                                  }
                                  ...
                                  { ?>
                                     ...
                                     <div class="col-md-10">
                                        <div class="form-group <?php echo form_error('custom_task_id') ? ' has-error' : ''; ?>">
                                           <?php echo  form_label('Task Name', 'custom_task_id'); ?> 
                                           <label class="form-control"> <?php echo $task_data_array->name; ?> </label>
                                        </div>
                                     </div>
                                     <?php
                                     
                                     echo "<input type='hidden' name='custom_task_id' value='".$custom_task_id."'>";
                                  } ?>
