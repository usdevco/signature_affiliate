               ...
               <div class="panel-body">
                <div class="row _buttons">
                     <div class="col-md-8">
                        ...
                        {
                           ?>
                              <a href="<?php echo base_url('admin/tasks/hoa_details_for_task'); ?>" class="btn btn-warning mleft10 pull-left"> Task Hoa </a>
                           <?php
                        } ?>

                         <a href="<?php echo base_url('admin/tasks/check_list'); ?>" class="btn btn-danger mleft10 pull-left"> Check List </a>
                        ...
                        {
                           ?>
                              <!-- <a href="<?php //echo base_url('admin/tasks/custom_task'); ?>" class="btn btn-warning mleft10 pull-left"> Create Custom Task </a> -->
                           <?php
                        } ?>
