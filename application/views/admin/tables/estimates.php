...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, [
    ...
    'hash',
    '(SELECT CONCAT(firstname, " ", lastname) as contact_fullname FROM tblcontacts WHERE tblcontacts.userid = tblestimates.clientid) as contact_fullname',
]);
...
foreach ($rResult as $aRow) {
    ...
    if (empty($aRow['deleted_customer_name'])) {
        $row[] = '<a href="' . admin_url('clients/client/' . $aRow['clientid']) . '">' . $aRow['contact_fullname'] . '</a>';
    } else {
