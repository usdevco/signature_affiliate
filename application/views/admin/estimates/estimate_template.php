         ...
         <div class="col-md-6">
            <div class="f_client_id">
             <div class="form-group select-placeholder">
                ...
                <?php 
                  $lead_id = isset($lead_client_data->leadid) ? $lead_client_data->leadid : NULL;
                  if($lead_id)
                  { ?>
                        <select  class="selectpicker display-block mbot15" name="clientid" data-width="100%">
                        
                           
                           <option  value="<?php echo $lead_client_data->userid; ?>"><?php echo $lead_client_data->firstname.' '.$lead_client_data->lastname; ?>
            ...
            <div class="d-none form-group select-placeholder projects-wrapper<?php if((!isset($estimate)) || (isset($estimate) && !customer_has_projects($estimate->clientid))){ echo ' hide';} ?>">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <address>
                     ...
                     <?php $billing_street = (isset($estimate) ? $estimate->billing_street : (isset($client_contact_data->billing_street) ? $client_contact_data->billing_street :'--')); ?>
                     <?php $billing_street = ($billing_street == '' ? '--' :$billing_street); ?>
                     <?php echo $billing_street; ?></span><br>
                     <span class="billing_city">
                     <?php $billing_city = (isset($estimate) ? $estimate->billing_city : (isset($client_contact_data->billing_city) ? $client_contact_data->billing_city :'--')); ?>
                     <?php $billing_city = ($billing_city == '' ? '--' :$billing_city); ?>
                     <?php echo $billing_city; ?></span>,
                     <span class="billing_state">
                     <?php $billing_state = (isset($estimate) ? $estimate->billing_state : (isset($client_contact_data->billing_state) ? $client_contact_data->billing_state :'--')); ?>
                     <?php $billing_state = ($billing_state == '' ? '--' :$billing_state); ?>
                     <?php echo $billing_state; ?></span>
                     <br/>
                     <span class="billing_country">
                     <?php $billing_country = (isset($estimate) ? get_country_short_name($estimate->billing_country) : (isset($client_contact_data->billing_country) ? $client_contact_data->billing_country :'--')); ?>
                     <?php $billing_country = ($billing_country == '' ? '--' :$billing_country); ?>
                     <?php echo $billing_country; ?></span>,
                     <span class="billing_zip">
                     <?php $billing_zip = (isset($estimate) ? $estimate->billing_zip : (isset($client_contact_data->billing_zip) ? $client_contact_data->billing_zip :'--')); ?>
               ...
               <div class="col-md-6">
                  ...
                  <address>
                     ...
                     <?php $shipping_street = (isset($estimate) ? $estimate->shipping_street : (isset($client_contact_data->shipping_street) ? $client_contact_data->shipping_street :'--')); ?>
                     <?php $shipping_street = ($shipping_street == '' ? '--' :$shipping_street); ?>
                     <?php echo $shipping_street; ?></span><br>
                     <span class="shipping_city">
                     <?php $shipping_city = (isset($estimate) ? $estimate->shipping_city : (isset($client_contact_data->shipping_city) ? $client_contact_data->shipping_city :'--')); ?>
                     <?php $shipping_city = ($shipping_city == '' ? '--' :$shipping_city); ?>
                     <?php echo $shipping_city; ?></span>,
                     <span class="shipping_state">
                     <?php $shipping_state = (isset($estimate) ? $estimate->shipping_state : (isset($client_contact_data->shipping_state) ? $client_contact_data->shipping_state :'--')); ?>
                     <?php $shipping_state = ($shipping_state == '' ? '--' :$shipping_state); ?>
                     <?php echo $shipping_state; ?></span>
                     <br/>
                     <span class="shipping_country">
                     <?php $shipping_country = (isset($estimate) ? get_country_short_name($estimate->shipping_country) : (isset($client_contact_data->shipping_country) ? $client_contact_data->shipping_country :'--')); ?>
                     <?php $shipping_country = ($shipping_country == '' ? '--' :$shipping_country); ?>
                     <?php echo $shipping_country; ?></span>,
                     <span class="shipping_zip">
                     <?php $shipping_zip = (isset($estimate) ? $estimate->shipping_zip : (isset($client_contact_data->shipping_zip) ? $client_contact_data->shipping_zip :'--')); ?>
         ...
         <div class="col-md-6">
            <div class="panel_s no-shadow">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                         <?php
                         $assigned =isset( $lead_data->assigned) ?  $lead_data->assigned : NULL;
                        $selected = $assigned;
