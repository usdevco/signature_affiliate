  ...
  <div class="row">
   ...
   <div class="top-lead-menu">
      ...
      <ul class="nav-tabs-horizontal nav nav-tabs<?php if(!isset($lead)){echo ' lead-new';} ?>" role="tablist">
         ...
         <li role="presentation">
            <a href="#tab_estimate_leads" onclick="initDataTable('.table-estimate-lead', admin_url + 'estimates/estimates_relations/' + <?php echo $lead->id; ?> + '/lead','undefined', 'undefined','undefined',[6,'desc']);" aria-controls="tab_estimate_leads" role="tab" data-toggle="tab">
   ...
   <div class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane" id="tab_estimate_leads">
         <?php if(has_permission('estimates','','create')){ ?>
         <a href="<?php echo admin_url('estimates/estimate?rel_type=lead&rel_id='.$lead->id); ?>" class="btn btn-info mbot25"><?php echo _l('New Estimate'); ?></a>
         <?php } ?>
         <?php
        ...
        render_datatable($table_data,'estimate-lead',[], [
